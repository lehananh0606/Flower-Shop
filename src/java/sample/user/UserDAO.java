...
public class UserDAO {
    ...
    private static final String LOGIN_2 = "SELECT Top 2 userID FROM tblUsers ";
...
//            ptm=conn.prepareStatement(LOGIN);
    ...
    public List<UserDTO> getListUser2(String search) throws SQLException {
        ...
        try {
            conn = DBUtils.getConnection();
            ptm = conn.prepareStatement(LOGIN_2);
