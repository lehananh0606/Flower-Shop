...
public class MainController extends HttpServlet {
    ...
    private static final String LOGIN_2 = "Search2";
    private static final String LOGIN_2_CONTROLLER = "heheController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else if (LOGIN_2.equals(action)) {
                url = LOGIN_2_CONTROLLER;
            } else {
